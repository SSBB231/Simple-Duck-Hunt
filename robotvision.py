...
class RobotEye(object):
    def __init__(self, window, target_color = None):
    ...
    def get_snapshot(self):
        ...
        # threshold against the color we got before
            self.mask = pygame.mask.from_threshold(self.snapshot, self.target_color, (30, 30, 30))
	...
	self.display.blit(snapshot, (int(self.display.get_width()*0.8), int(self.display.get_height()*0.8)))
